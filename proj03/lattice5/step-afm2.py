...
for row in buffer:
    ...
    OPTIONS = np.linspace(0.94, 1.02, 9)
    ...
    for opt in OPTIONS:
        ...
        alloys.append(Alloy(3, 'Fe', fe, -1.0))
        alloys.append(Alloy(4, 'Fe', fe, -1.0))

        if mn > 1e-7:
            alloys.append(Alloy(1, 'Mn', mn, 1.0))
            alloys.append(Alloy(2, 'Mn', mn, 1.0))
            alloys.append(Alloy(3, 'Mn', mn, -1.0))
            alloys.append(Alloy(4, 'Mn', mn, -1.0))
        if ni > 1e-7:
            alloys.append(Alloy(1, 'Ni', ni, 1.0))
            alloys.append(Alloy(2, 'Ni', ni, 1.0))
            alloys.append(Alloy(3, 'Ni', ni, -1.0))
            alloys.append(Alloy(4, 'Ni', ni, -1.0))
        if cr > 1e-7:
            alloys.append(Alloy(1, 'Cr', cr, 1.0))
            alloys.append(Alloy(2, 'Cr', cr, 1.0))
            alloys.append(Alloy(3, 'Cr', cr, -1.0))
            alloys.append(Alloy(4, 'Cr', cr, -1.0))
        if al > 1e-7:
            alloys.append(Alloy(1, 'Al', al, 1.0))
            alloys.append(Alloy(2, 'Al', al, 1.0))
            alloys.append(Alloy(3, 'Al', al, -1.0))
            alloys.append(Alloy(4, 'Al', al, -1.0))
        if si > 1e-7:
            alloys.append(Alloy(1, 'Si', si, 1.0))
            alloys.append(Alloy(2, 'Si', si, 1.0))
            alloys.append(Alloy(3, 'Si', si, -1.0))
            alloys.append(Alloy(4, 'Si', si, -1.0))
        if mo > 1e-7:
            alloys.append(Alloy(1, 'Mo', mo, 1.0))
            alloys.append(Alloy(2, 'Mo', mo, 1.0))
            alloys.append(Alloy(3, 'Mo', mo, -1.0))
            alloys.append(Alloy(4, 'Mo', mo, -1.0))
        if co > 1e-7:
            alloys.append(Alloy(1, 'Co', co, 1.0))
            alloys.append(Alloy(2, 'Co', co, 1.0))
            alloys.append(Alloy(3, 'Co', co, -1.0))
            alloys.append(Alloy(4, 'Co', co, -1.0))
        if cu > 1e-7:
            alloys.append(Alloy(1, 'Cu', cu, 1.0))
            alloys.append(Alloy(2, 'Cu', cu, 1.0))
            alloys.append(Alloy(3, 'Cu', cu, -1.0))
            alloys.append(Alloy(4, 'Cu', cu, -1.0))
        if nb > 1e-7:
            alloys.append(Alloy(1, 'Nb', nb, 1.0))
            alloys.append(Alloy(2, 'Nb', nb, 1.0))
            alloys.append(Alloy(3, 'Nb', nb, -1.0))
            alloys.append(Alloy(4, 'Nb', nb, -1.0))
        if ti > 1e-7:
            alloys.append(Alloy(1, 'Ti', ti, 1.0))
            alloys.append(Alloy(2, 'Ti', ti, 1.0))
            alloys.append(Alloy(3, 'Ti', ti, -1.0))
            alloys.append(Alloy(4, 'Ti', ti, -1.0))
        if v > 1e-7:
            alloys.append(Alloy(1, 'V', v, 1.0))
            alloys.append(Alloy(2, 'V', v, 1.0))
            alloys.append(Alloy(3, 'V', v, -1.0))
            alloys.append(Alloy(4, 'V', v, -1.0))
        if w > 1e-7:
            alloys.append(Alloy(1, 'W', w, 1.0))
            alloys.append(Alloy(2, 'W', w, 1.0))
            alloys.append(Alloy(3, 'W', w, -1.0))
            alloys.append(Alloy(4, 'W', w, -1.0))
