...
for opt in OPTIONS:
    ...
    alloys.append(Alloy(1, 'Fe', fe/2, -1.0))
    alloys.append(Alloy(1, 'Ni', 0.1, 0.0))

    alloys2 = []

    alloys2.append(Alloy(1, 'Mn', opt, 0.0))
    alloys2.append(Alloy(1, 'Fe', fe, 0.0))
    alloys2.append(Alloy(1, 'Ni', 0.1, 0.0))
